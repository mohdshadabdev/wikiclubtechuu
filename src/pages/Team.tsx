              ...
              <Card className="glass hover-lift">
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-lg text-foreground/80 mb-8 leading-relaxed">
                    Team details will be updated soon. We're working on creating comprehensive profiles 
                    of our dedicated team members who work tirelessly to promote open knowledge and 
                    technological innovation.
                  </p>
                  
                  <p className="text-foreground/70">
                    Meet the passionate individuals behind Wiki Club Tech - from organizers and mentors 
                    to active contributors and community leaders!
                  </p>
                </CardContent>
              </Card>
            </div>
